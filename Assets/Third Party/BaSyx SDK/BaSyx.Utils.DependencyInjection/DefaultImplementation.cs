...
namespace BaSyx.Utils.DependencyInjection
{
    public static class DefaultImplementation
    {
        public static IServiceCollection AddStandardImplementation(this IServiceCollection services)
        {
            ...
            services.AddTransient<ISubmodel, BaSyx.Models.Core.AssetAdministrationShell.Implementations.Submodel>();
            ...
            services.AddTransient(typeof(IReference<ISubmodel>), typeof(Reference<BaSyx.Models.Core.AssetAdministrationShell.Implementations.Submodel>));

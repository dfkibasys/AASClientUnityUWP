...
namespace BaSyx.Models.Core.Attributes
{
    ...
    {
        private BaSyx.Models.Core.AssetAdministrationShell.Implementations.Submodel _submodel;
        public AssetAdministrationShell.Implementations.Submodel Submodel => Build();

        private AssetAdministrationShell.Implementations.Submodel Build()
        {
            _submodel = new AssetAdministrationShell.Implementations.Submodel(IdShort, Identification)
            {
